...
contract StrategyPendleRocketTest is DSTest {
    ...
    function setUp() public {
        ...
        reth = IERC20(0xEC70Dcb4A1EFa46b8F2D97C310C9c4790ba5ffA8);
        ...
        oREth = IOracle(0xbE24270F4450C0C44a2aA3fc08081d1dF0BCD081); // rETH/USD
        ...
        mrkt = IPMarket(0x14FbC760eFaF36781cB0eb3Cb255aD976117B9Bd); // PT-rETH-26JUN25/SY-rETH Market

        hlp.setOracle(address(reth), address(oREth));
        ...
        hlp.setPath(
            ...
            address(reth),
            address(hlpV3),
            abi.encodePacked(address(ast), uint24(500), address(weth), uint24(500), address(reth))
        );
        ...
        hlp.setPath(
            ...
            address(ast),
            address(hlpV3),
            abi.encodePacked(address(reth), uint24(500), address(weth), uint24(500), address(ast))
        );
        ...
        str =
        new StrategyPendleLSD(address(hlp), address(lphlp), address(prtr), address(mrkt), address(reth), address(weth), address(ast));
    ...
    function testMint() public {
        ...
        uint256 expectedSha = 284810343933712752;
    ...
    function testBurn() public {
        ...
        uint256 expectedBurnedAmount = 997513752;
    ...
    function testRate() public {
        ...
        uint256 expectedRate = 997390014120363341868;
